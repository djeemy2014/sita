    ...
    constructor(props) {
      ...
      componentDidMount() {
        ...
        .then(async (viewer)=>{
            ...
            console.log(viewer.current.cesiumElement.timeline)
            //let currentTime = JulianDateCesium.now()
            //let startTime = currentTime.clone()
            //startTime.dayNumber=currentTime.dayNumber-2
            //let stopTime = currentTime.clone()
            //stopTime.dayNumber=currentTime.dayNumber+2
            //let a = new TimelineCesium(document.querySelector('.timeLine'),new ClockCesium({
            //   currentTime: JulianDateCesium.now(),
            //   startTime: startTime,
            //   stopTime: stopTime,
            //  //startTime : JulianDateCesium.fromIso8601("2013-12-25"),
            //  //currentTime : JulianDateCesium.fromIso8601("2013-12-25"),
            //  //stopTime : JulianDateCesium.fromIso8601("2013-12-26"),
            //}))
            //console.log(a)
            //console.log(credit2)
...
class TVSComponentCesium extends Component{
    constructor(props) {
        super(props);
        this.state={
          scene:props.scene,
...
export default TVSComponentCesium